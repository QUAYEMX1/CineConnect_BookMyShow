...
public interface SeatSelectionRepository extends JpaRepository<SeatSelection, Integer> {
    List<SeatSelection> findByShowAndStatusAndCreatedAtAfter(Show show, String status, LocalDateTime cutoffTime);
    ...
    void deleteExpiredTempSelections(LocalDateTime cutoffTime);
}
